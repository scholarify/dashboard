...
const DeleteClassModal: React.FC<DeleteInvitationModalProps> = ({
  className,
  onClose,
  onDelete,
  submitStatus,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md mx-4 sm:mx-6 md:mx-0 p-6 relative">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-foreground">Delete Invitation</h2>
          ...
          <SubmissionFeedback status={submitStatus}
            message={
              submitStatus === "success"
                ...
                : "There was an error deleting this invitation. Try again and if this persist contact support!"
            } />
        ) : (
          <>
